...
const CreatePost = () => {
  const navigate=useNavigate(); //this will allow us to navigate back to home page once the post is created.
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        <h1 className='font
        extrabold text-[#222328] text-[32px]'>Create</h1>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        {/* this down one is for submit button */}
